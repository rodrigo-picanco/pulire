<html>
  ...
  <body class="mx-auto w-full md:w-5xl flex flex-col gap-8 align-center">
    <div class="p-2">
      <h1 class="font-sans font-black text-8xl uppercase">pulire</h1>
      <nav>
        {{ if .Filter }}
    ...
    <main class="flex flex-col md:flex-row">
      <div class="grow flex gap-4 flex-col md:order-last md:max-w-sm">
        {{ if .Filter }}
          <form action="/task" class="flex flex-col gap-2 md:border-l border-stone-600 p-2" method="POST">
